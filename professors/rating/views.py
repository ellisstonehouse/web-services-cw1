...
def rate(request):
    ...
    if not logged_in_user:
        ...
        try:
            professor_id = request.PUT.get("professor_id", "")
            module_id = request.PUT.get("module_id", "")
            year = int(request.PUT.get("year", ""))
            semester = int(request.PUT.get("semester", ""))
            rating = int(request.PUT.get("rating", ""))
